...
extern "C" {
    #[link_name = "cyclors_0_3_1_ddsi_serdata_size"]
    pub fn ddsi_serdata_size(d: *const ddsi_serdata) -> u32;
}
extern "C" {
    #[link_name = "cyclors_0_3_1_ddsi_serdata_to_ser_ref"]
...
extern "C" {
    #[link_name = "cyclors_0_3_1_ddsi_serdata_unref"]
    pub fn ddsi_serdata_unref(serdata: *mut ddsi_serdata);
}
extern "C" {
    #[link_name = "cyclors_0_3_1_ddsi_serdata_to_ser_unref"]
    pub fn ddsi_serdata_to_ser_unref(d: *mut ddsi_serdata, ref_: *const ddsrt_iovec_t);
}
extern "C" {
    #[link_name = "cyclors_0_3_1_ddsi_serdata_from_ser_iov"]
...
extern "C" {
    #[link_name = "cyclors_0_3_1_ddsi_serdata_from_sample"]
